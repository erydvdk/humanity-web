...
const SignIn = () => {
  ...
  return (
    <Layout
      ...
      description={"Sign in to your account to access volunteer opportunities and manage your profile with Namaskar Humanity Welfare Society."}
      ...
      <section className="relative py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Sign <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500">In</span>
            </motion.h1>
