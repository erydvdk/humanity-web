      ...
      <section className="relative py-20 bg-gradient-to-br from-green-600 via-blue-600 to-purple-700 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Verified <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500">Certificates</span>
            </motion.h1>
            ...
            >
              Our commitment to transparency and accountability is validated through government-verified 
              certificates, ensuring your trust and confidence in our mission.
            </motion.p>
          ...
          >
            <motion.div variants={itemVariants} className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>
                Why Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-600">Verification</span> Matters
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto" style={{ fontFamily: "'Inter', sans-serif" }}>
                Our government certifications ensure transparency, legal compliance, and tax benefits for all contributors.
              </p>
            </motion.div>
          ...
          >
            <motion.div variants={itemVariants} className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>
                Government Verified <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Certificates</span>
            </h2>
              <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-purple-600 mx-auto mb-8"></div>
              <p className="text-xl text-gray-600 leading-relaxed max-w-4xl mx-auto" style={{ fontFamily: "'Inter', sans-serif" }}>
                Namaskar Humanity Welfare Society is a 12A & 80G registered NGO dedicated to uplifting 
                marginalized communities. Our verified certificates ensure transparency, accountability, 
                and legitimacy in all our social welfare initiatives.
              </p>
            </motion.div>
            ...
            >
              {certificates.map((cert, index) => (
                ...
                >
                  ...
                  {/* Certificate Details */}
                  <div className="p-6">
                    <p className="text-gray-600 leading-relaxed mb-4 text-sm" style={{ fontFamily: "'Inter', sans-serif" }}>
                      {cert.title}
                    </p>
            ...
            <motion.div variants={itemVariants} className="text-center mt-16">
              <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 max-w-4xl mx-auto">
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
                  ...
                  your donations are used effectively for social impact. Join thousands who trust 
                  us to create meaningful change.
                </p>
                ...
                <div className="mt-8 bg-green-50 border border-green-200 rounded-xl p-4">
                  <p className="text-green-800 text-sm font-medium" style={{ fontFamily: "'Inter', sans-serif" }}>
                    <strong>Tax Benefit:</strong> All donations to Namaskar Humanity Welfare Society are eligible 
                    for 80G tax deductions as per Income Tax Act.
            </p>
          </div>
          </div>
            </motion.div>
