...
import { FaImage, FaUser, FaEnvelope, FaPhone, FaGraduationCap, FaMapMarkerAlt, FaHeart, FaCheckCircle } from "react-icons/fa";
...
const VolunteerForm = () => {
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="bg-white rounded-3xl shadow-2xl p-12 border border-green-100">
                ...
                >
                  Thank you <strong>{name}</strong> for joining our volunteer community! We're excited to have you on board. 
  ...
  return (
    <Layout
      ...
      description={"Join our volunteer community and make a difference. Register as a volunteer with Namaskar Humanity Welfare Society to contribute to meaningful social causes."}
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.h1 
              ...
              style={{ fontFamily: "'Poppins', sans-serif" }}
            >
              Become a <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500">Volunteer</span>
            </motion.h1>
            ...
            <motion.p 
              ...
              style={{ fontFamily: "'Inter', sans-serif" }}
            >
              Join our community of passionate changemakers and help us create lasting impact in society.
            </motion.p>
          </motion.div>
        </div>
            ...
            >
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto" style={{ fontFamily: "'Inter', sans-serif" }}>
                  Fill out this form to join our volunteer community and start making a difference in people's lives.
                </p>
              </div>

              <form onSubmit={handleSubmit} className="space-y-8">
                <motion.div variants={itemVariants} className="bg-blue-50 rounded-xl p-6 border border-blue-100">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center gap-2" style={{ fontFamily: "'Poppins', sans-serif" }}>
                ...
                <motion.div variants={itemVariants} className="bg-purple-50 rounded-xl p-6 border border-purple-100">
                  <h3 className="text-xl font-semibold text-gray-900 mb-6 flex items-center gap-2" style={{ fontFamily: "'Poppins', sans-serif" }}>
                ...
                <motion.div variants={itemVariants} className="text-center pt-6">
                  ...
                  <p className="text-sm text-gray-600 mt-4" style={{ fontFamily: "'Inter', sans-serif" }}>
                    By submitting this form, you agree to join our volunteer community and contribute to our mission.
                  </p>
                </motion.div>
              </form>
            </motion.div>
