...
const SignUp = () => {
  ...
  return (
    <Layout
      ...
      description={"Create your account to join our volunteer community and start making a difference in lives across India."}
      ...
      <section className="relative py-20 bg-gradient-to-br from-green-600 via-blue-600 to-purple-700 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Create <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500">Account</span>
            </motion.h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.div variants={itemVariants}>
                  <motion.button
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full inline-flex items-center justify-center rounded-xl border-2 border-gray-300 bg-white px-4 py-3 font-semibold text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 shadow-sm"
                    style={{ fontFamily: "'Inter', sans-serif" }}
                  >
              ...
              <motion.div variants={itemVariants} className="mt-8 text-center">
                <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 border border-green-100">
                  ...
                  <p className="text-gray-600 mb-4 text-sm" style={{ fontFamily: "'Inter', sans-serif" }}>
                    By creating an account, you'll be able to join volunteer programs, track your impact, and connect with like-minded changemakers.
                  </p>
                  <Link
