      ...
      <section className="relative py-20 bg-gradient-to-br from-orange-600 via-red-600 to-purple-700 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              About <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500">Our Mission</span>
            </motion.h1>
            ...
            >
              Made with love, right here in India. Every initiative is born from the heart, 
              rooted in compassion and unity, creating lasting change across communities.
            </motion.p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <motion.div variants={itemVariants}>
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>
                  Made with love, right here in <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-red-600">India</span>
                </h2>
                <p className="text-lg text-gray-600 leading-relaxed mb-8" style={{ fontFamily: "'Inter', sans-serif" }}>
                  At Namaskar Humanity Welfare Society, every initiative, every act of kindness, and every step towards a brighter future is born from the heart of India. Rooted in the rich heritage of compassion and unity, our work is a reflection of the love we carry for our people and our nation.
                </p>
                <p className="text-lg text-gray-600 leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
                  From the vibrant cities to the quiet villages, our efforts span across India, touching lives and spreading hope. With deep pride in our country and unwavering commitment to its people, we create lasting change—crafted with love, right here in the heart of India.
                </p>
              </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={itemVariants} className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>
                Our Core <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-red-600">Values</span>
              </h2>
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto" style={{ fontFamily: "'Inter', sans-serif" }}>
                The principles that guide our mission and shape every interaction with the communities we serve.
              </p>
            </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={itemVariants} className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>
                Visit <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-red-600">Our Office</span>
              </h2>
            </motion.div>

            <motion.div variants={itemVariants} className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 border border-orange-100">
            {locations.map((location) => (
                <div key={location.title} className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
          ...
          >
            <motion.div variants={itemVariants} className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-4xl mx-auto" style={{ fontFamily: "'Inter', sans-serif" }}>
                We are a passionate group of individuals united by a common purpose – to bring positive change and uplift communities in need. Our team is a vibrant mix of visionaries, social workers, and volunteers, all working together with unwavering dedication and integrity.
              </p>
            </motion.div>
              ...
              >
                {teamData?.data?.map((user, index) => (
                  ...
                  />
                    ...
                    <div className="p-6">
                      <h3 className="text-xl font-semibold text-gray-900 mb-2 group-hover:text-orange-600 transition-colors duration-300" style={{ fontFamily: "'Poppins', sans-serif" }}>
                    {user?.name}
                      </h3>
                      <p className="text-sm font-medium text-gray-500 bg-orange-50 px-3 py-1 rounded-full inline-block" style={{ fontFamily: "'Inter', sans-serif" }}>
                    {user?.role}
                  </p>
                </div>
                  </motion.div>
            ...
            <motion.div variants={itemVariants} className="text-center mt-16">
              <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 max-w-4xl mx-auto">
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
                  At Namaskar Humanity Welfare Society, our journey of compassion and service has only just begun. Every step we take, every hand we hold, and every life we touch inspires us to dream bigger and do more. Together, with the power of community, we are building a brighter tomorrow.
                </p>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <motion.div variants={itemVariants}>
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>
                  Ready to Make a <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-red-600">Difference?</span>
                </h2>
                <p className="text-lg text-gray-600 leading-relaxed mb-8" style={{ fontFamily: "'Inter', sans-serif" }}>
                  At Namaskar Humanity Welfare Society, our journey of compassion and service has only just begun. While we've already made an impact, we know the road ahead is filled with new challenges and endless opportunities to uplift humanity. With hearts full of hope and unwavering commitment, we are ready to reach farther, serve deeper, and spread kindness in ways we've only imagined.
                </p>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
